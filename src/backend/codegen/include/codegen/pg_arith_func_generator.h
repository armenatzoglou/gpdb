...
static bool CreateOverflowCheckLogic(
  ...
  *llvm_out_value = irb->CreateLoad(irb->CreateInBoundsGEP(llvm_arith_output->getType(),
                                                           llvm_arith_output,
                                                           {codegen_utils->GetConstant(0),
                                                               codegen_utils->GetConstant(0)}));
  llvm::Value* llvm_overflow_flag =
      irb->CreateLoad(irb->CreateInBoundsGEP(llvm_arith_output->getType(),
                                                                 llvm_arith_output,
                                                                 {codegen_utils->GetConstant(0),
                                                                     codegen_utils->GetConstant(1)}));
